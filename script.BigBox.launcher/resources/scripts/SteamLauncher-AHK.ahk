...
;Manual script usage: Big-Box.exe "e:\path\to\steam.exe" "d:\path\to\kodi.exe" "0/1" "true/false" "scriptpath/false" "scriptpath/false"
...
;
;BigBox.launcher.script.revision=999
