'''
    ...
    Updated by TheHighway (2017) for use on Krypton version of Kodi (XBMC)
...
class Addon:
    ...
    def add_item(self, queries, infolabels, properties=None, contextmenu_items='', context_replace=False, img='',
        ...
        if playlist is not False:
            ...
            xbmcplugin.addDirectoryItem(self.handle, url=play, listitem=listitem, isFolder=is_folder) #Change made for sake of Krypton.
    ...
    def end_of_directory(self):
        ...
        xbmcplugin.endOfDirectory(handle=int(self.handle), succeeded=True) #Change made for sake of Krypton.
