...
def firstRun():
	class MyWindow(xbmcgui.WindowXMLDialog):
		def __init__(self, *args, **kwargs):
			...
			self.msg   = "No se ha detectado ningun Wizard %s instalada.\n\nElige 'Build Menu' Para Instalar El Wizard Breaking Bad\n Gracias Por Elegir Wizard Breaking Bad\n\nEnrra En Nuestro Grupo De Telegram%s." % (ADDONTITLE, ADDONTITLE)
